alias edebug='sudo php5enmod xdebug;sudo service php5.6-fpm restart;sudo service nginx restart'
alias ddebug='sudo php5dismod xdebug;sudo service php5.6-fpm restart;sudo service nginx restart'
